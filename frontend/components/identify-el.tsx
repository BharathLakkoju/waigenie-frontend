                  ...
                  <td className="px-4 py-2">
                    <details>
                      ...
                      <div className="mt-2 space-y-1 text-xs">
                        ...
                        <div>
                          <span className="font-semibold">Relative XPath:</span>{" "}
                          {element.relativeXPath}
                        </div>
                        <div>
                          <span className="font-semibold">Absolute XPath:</span>{" "}
                  ...
                  <td className="px-4 py-2">
                    <details>
                      ...
                      <div className="mt-2 space-y-1 text-xs">
                        ...
                        <div>
                          Position: {element.siblings.siblingPosition + 1} of{" "}
                  ...
                  <div key={id} className="border p-4 rounded-md">
                    ...
                    <div className="mt-2 space-y-2">
                      <div>
                        Accessibility Score:{" "}
                        {
                          Object.values(element.accessibility).filter(Boolean)
                            .length
                        }
                        /7
                      </div>
