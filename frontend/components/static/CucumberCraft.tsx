  ...
  return (
    ...
    >
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 max-md:mt-16">
        {/* Hero Section */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 lg:gap-32 mb-12 sm:mb-20 min-h-[70vh] sm:min-h-[85vh]">
          <motion.div
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <div className="absolute inset-0 bg-blue-200 rounded-lg transform rotate-3 w-full aspect-[500/525]"></div>
              <Image
        ...
        <motion.section className="flex flex-col justify-center items-center gap-6 sm:gap-10">
          <motion.h1
            ...
            animate={{ y: 0 }}
            transition={{ duration: 0.5, delay: 0.3 }}
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 text-center px-4"
          >
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="mb-12 sm:mb-20 min-h-[24rem]"
        >
          <motion.h2
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 px-4">
            {[
              {
                icon: <FileText className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
                title: "Gherkin Generation",
                description:
                  "Automatically convert user stories into Gherkin syntax feature files.",
              },
              {
                icon: <Layers className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
                title: "Scenario Expansion",
                description:
                  "Intelligently expand scenarios with relevant examples and edge cases.",
              },
              {
                icon: <GitBranch className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
                title: "Version Control Integration",
                description:
                  "Seamlessly integrate with popular version control systems for easy collaboration.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <span className="text-2xl sm:text-4xl text-center font-bold mb-8 sm:mb-12">Benefits</span>
        ...
        >
          ...
          >
            Ready to Streamline Your BDD Process?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          <Link href="/signup">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-full text-sm sm:text-base"
              >
                Start Crafting Your Gherkin Steps Now <ArrowRight className="ml-1 w-4 h-4 sm:w-6 sm:h-6" />
              </Button>
            </motion.div>
          </Link>
        </motion.section>
