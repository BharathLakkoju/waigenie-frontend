    ...
    >
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 max-md:mt-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 lg:gap-32 mb-12 sm:mb-20 min-h-[70vh] sm:min-h-[85vh]">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/">
                ...
                >
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-blue-200 to-indigo-300 hover:from-blue-300 hover:to-indigo-400 text-black rounded-full text-sm sm:text-base"
                  >
                    Learn more
                  </Button>
                </motion.div>
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <div className="absolute inset-0 bg-blue-200 rounded-lg transform rotate-3 w-full max-w-[500px] aspect-[20/21]"></div>
              <Image
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              {
                icon: <Compass className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
              ...
              {
                icon: <Map className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
        ...
        >
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 md:p-12 w-full max-w-4xl mx-auto">
            <motion.h2
              initial={{ y: 20, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
