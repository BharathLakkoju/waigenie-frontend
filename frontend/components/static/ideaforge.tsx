      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 max-md:mt-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 lg:gap-32 mb-12 sm:mb-20 min-h-[70vh] sm:min-h-[85vh]">
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <div className="absolute inset-0 bg-blue-200 rounded-lg transform rotate-3 w-full max-w-[500px] h-auto aspect-[500/525] mx-auto"></div>
              <Image
                src="/IdeaForgeimage.png?"
                alt="IdeaForge illustration"
                width={500}
                height={525}
                className="relative z-10 rounded-lg shadow-xl w-full max-w-[500px] h-auto mx-auto"
              />
            </motion.div>
          </motion.div>
        </div>
        ...
        <motion.section className="flex flex-col justify-center items-center gap-6 sm:gap-10">
          <motion.h1
            ...
            animate={{ y: 0 }}
            transition={{ duration: 0.5, delay: 0.3 }}
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 text-center"
          >
            Understand how the IdeaForge works
          </motion.h1>
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="flex justify-center items-center mb-16 sm:mb-32 w-full"
          >
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              {
                icon: <Brain className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-600" />,
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="flex flex-col items-center my-16 sm:my-32"
        >
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="text-center mt-16 sm:mt-32"
        >
          <motion.h2
            initial={{ scale: 0.9 }}
            whileInView={{ scale: 1 }}
          ...
          <Link href="/signup">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-full text-sm sm:text-base"
              >
                Start Testing Your Ideas <ArrowRight className="ml-1 w-4 h-4 sm:w-6 sm:h-6" />
              </Button>
            </motion.div>
          </Link>
        </motion.section>
